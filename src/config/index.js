...
var initializeRoles_1 = __importDefault(require("../utils/initializeRoles"));
...
function initServer() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.initDatabaseConnection()];
                case 1:
                    _a.sent();
                    //we need to be sure that the roles are available before
                    //any other process can request them
                    return [4 /*yield*/, initializeRoles_1.default()];
                case 2:
                    //we need to be sure that the roles are available before
                    //any other process can request them
                    _a.sent();
                    port = process.env.PORT || 8000;
                    app_1.default.listen(port, function () { return console.log("API available on port " + port); });
                    return [2 /*return*/];
            }
        });
    });

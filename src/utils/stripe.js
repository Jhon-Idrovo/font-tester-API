 ...
 */
function getOrCreateCustomer(user) {
    return __awaiter(this, void 0, void 0, function () {
        var customer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!user.stripeID) return [3 /*break*/, 2];
                    return [4 /*yield*/, stripe_1.stripe.customers.retrieve(user.stripeID)];
                case 1: return [2 /*return*/, _a.sent()];
                case 2: return [4 /*yield*/, stripe_1.stripe.customers.create({
                        email: user.email,

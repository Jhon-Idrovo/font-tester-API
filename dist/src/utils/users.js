...
exports.modifyCredit = exports.getOrCreateUser = void 0;
var Role_1 = __importDefault(require("../models/Role"));
var User_1 = __importDefault(require("../models/User"));
function getOrCreateUser(email, username, authMethod, password, authProviderId) {
    return __awaiter(this, void 0, void 0, function () {
        var user, role, _a, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, User_1.default.findOne({ email: email }).exec()];
                case 1:
                    user = _d.sent();
                ...
                case 3: return [4 /*yield*/, _b.apply(_a, [(_c.password = _d.sent(),
                            _c.authProviderId = authProviderId,
                            _c)])];
                case 4:
                    user = _d.sent();
                    _d.label = 5;
 ...
 */
function modifyCredit(user, creditAmount) {
    return __awaiter(this, void 0, void 0, function () {
...
exports.modifyCredit = modifyCredit;
